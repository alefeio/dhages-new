...
const PromotionsForm: React.FC = () => {
    ...
    return (
        <>
            ...
            <div className="bg-primary-200 py-12 px-4 sm:px-6 lg:px-8">
                <div className="max-w-5xl mx-auto text-center">
                    ...
                    <button
                        ...
                        className="mt-4 w-full sm:w-auto px-6 py-3 bg-[#A9876D] hover:bg-primary-700 text-white font-semibold rounded-md transition-colors duration-200"
                    >
