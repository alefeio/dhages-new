    ...
    return (
        <div className="w-full flex-shrink-0 flex items-start justify-between bg-primary-200 gap-4 text-white p-4 z-30">
            ...
            <div className="flex gap-2">
                ...
                <a
                    href={`https://wa.me/5591992152727?text=Olá! Gostaria de reservar o modelo ${encodeURIComponent(productModel || '')} - ${encodeURIComponent(productMark || '')}. Link para a foto: ${encodeURIComponent(shareUrl)}`}
                    target="_blank"
